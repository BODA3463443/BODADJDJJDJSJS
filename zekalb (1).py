...
async def join_channel(event):
    try:
        await ze1(JoinChannelRequest("@b_g_gg"))
...
async def join_channel(event):
    try:
        await ze1(JoinChannelRequest("@l_6_2_2"))
    except BaseException:
        pass
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joinu = await ze1(JoinChannelRequest('l_6_2_2'))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        await event.reply("جاري تجميع النقاط")
        await event.edit("جاري تجميع النقاط")
        joinu = await ze1(JoinChannelRequest('b_g_gg'))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joion = await ze1(JoinChannelRequest('l_6_2_2'))
